...
class Calculator:
    ...
    def math_button_press(self, value):
        ...
        if self.isfloot(str(self.number_entry.get())):
            div_trigger = False
            mul_trigger = False
            add_trigger = False
            sub_trigger = False
    ...
    def equal_button_press(self):
        ...
        if self.div_trigger or self.mul_trigger or self.add_trigger or self.sub_trigger:
    ...
    def __init__(self, root):
        ...
        root.title("Python Based Calculator")
...
#----4th Column----
        ...
        text="=", command=lambda: self.equal_button_press()).grid(row=4, column=2)

        self.button_sub = ttk.Button(root, 
        text="-", command=lambda: self.math_button_press('-')).grid(row=4, column=3)
